      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Transforming businesses through innovative software development solutions. 
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/muhammad-waseem-571a52197/" target='_blank' className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2026 Codedium. All rights reserved. Built with passion and cutting-edge technology.</p>
          </div>
        </div>
      </footer>
    </div>
